...
class CreamyBaconBuilder:
    ...
    def add_sauce(self):
        print("adding the creme friache sauce to your creamy bacon...")
        self.pizza.sauce = PizzaSauce.creme_fraiche
        time.sleep(STEP_DELAY)
        print("done with the creme friache sauce")

    def add_topping(self):
        topping_desc = "mozzarella, bacon, ham, muchrooms, red onion, oregano"
        topping_items = (
...
def validate_style(builders):
    ...
    try:
        ...
        error_msg = "Sorry, only margaritaa (key m) and creamy bacon (key c) are available"
        print(error_msg)
